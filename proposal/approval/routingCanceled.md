...
[#-- ------Place Proposal Team ans Support Team Template Here--------- --]

Subject: [Summit] Proposal ${proposal.identifier} has had Routing Canceled By ${proposal.approval.disposition.authority.displayName}

[@wrap]
Proposal ${proposal.identifier} has had routing canceled by ${proposal.approval.disposition.authority.displayName} for the following reason:
[/@wrap]
